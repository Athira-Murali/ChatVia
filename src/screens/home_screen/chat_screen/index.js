...
import { View, Text, StyleSheet, StatusBar, ScrollView, TextInput, TouchableWithoutFeedback, Pressable,PermissionsAndroid,SafeAreaView } from 'react-native';
      ...
      {isPermitted ? (
        <View style={{flex: 1}}>
          <CameraKitCameraScreen
            ...
            flashImages={{
              // Flash button images
              on: require('../../../assets/permission/flashon32.png'),
              off: require('../../../assets/permission/flashoff32.png'),
              auto: require('../../../assets/permission/flashauto32.png'),
            }}
            cameraFlipImage={require('../../../assets/permission/flip32.png')}
            captureButtonImage={require('../../../assets/permission/capture.jpg')}
          />
        </View>
                ...
                <View>
                    ...
                    <View style={styles.bottomBarContainer}>
                        ...
                        <View style={styles.chatOptionsContainer}>
                            ...
                            <Pressable style={styles.bottomIcon} android_ripple={{ color: 'rgba(0,0,0,0.3)' }}><MaterialIcons name="photo-camera" size={25} color="rgba(0,0,0,0.5)" onPress={openCamera} /></Pressable>
